Feature: Basketball
  ...
  Scenario Outline: Negative Registration Tests
    ...
    When I "<tickSelector>" Terms and Conditions
    And I tick I am adult
    And I tick code of ethics
    When I press submission button
    ...
    Examples:
      | browser | tickSelector | dateOfBirth | firstName | lastName  | email             | confirmEmail       | password  | confirmPassword | errorMessage                                                              |
      | Edge    | tick         | 20/03/1985  | Nick      |           | test2@example.com | test2@example.com  | 123QweAsd | 123QweAsd       | Last Name is required                                                     |
      | Chrome  | tick         | 20/03/1985  | Adam      | Johansson | test3@example.com | wrong2@example.com | 123QweAsd | 123QweAsd       | Confirm Email Address does not match                                      |
      | Chrome  | tick         | 20/03/1985  | John      | Avaltsson | test3@example.com | test3@example.com  | 123QweAsd | NoPass          | Password did not match                                                    |
      | Chrome  | notTick      | 20/03/1985  | John      | Avaltsson | test3@example.com | test3@example.com  | 123QweAsd | 123QweAsd       | You must confirm that you have read and accepted our Terms and Conditions |
