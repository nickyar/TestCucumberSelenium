...
#    Given I use "Chrome" as a browser
    ...
    When I enter my date of birth "20/03/1985"
    And I enter my first name "Nickyar"
  ...
  Scenario Outline: Negative Registration Tests
    ...
    Examples:
      ...
      | Edge    | 20/03/1985  | Nickyar   |          | test2@example.com | test2@example.com  | 123QweAsd | 123QweAsd       | Last Name is required                |
      | Chrome  | 20/03/1985  | Nickyar   | Ghadiri  | test3@example.com | wrong2@example.com | 123QweAsd | 123QweAsd       | Confirm Email Address does not match |
      | Chrome  | 20/03/1985  | Nickyar   | Ghadiri  | test3@example.com | test3@example.com  | 123QweAsd | NoPass          | Password did not match               |
